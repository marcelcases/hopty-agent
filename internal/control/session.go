...
func (s *Session) Run(ctx context.Context) error {
	...
	for {
		...
		if envelope.Type == "terminal.open" || envelope.Type == "terminal.signal" || envelope.Type == "terminal.close" || envelope.Type == "agent.pairing_verified" || envelope.Type == "agent.paired" {
			select {
